...
int main(void) {
	...
	char packetHeaderRecd[STRING_SIZE]; //Prof says we should make this a struct as well
	...
	//ntohs send_message[1]
		...
		headerBytesRecd = recv(sock_client, packetHeaderRecd , STRING_SIZE, 0); // prof says we should use a pointer to packetHeaderRecd
	//TODO error checking
